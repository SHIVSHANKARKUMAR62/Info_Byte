...
class Number{
    ...
    public void guessingNumber() {
        System.out.println("A number is chosen between 1 to 100 and Guess the number within 5 trials.");
        do {
            ...
            if (i == k) {
                System.out.println("You have exhausted " + k + " times.");
...
public class Number_Guessing_Game_Task {
